...
<head>
	<meta charset="UTF-8">
	<title>管理员操作界面</title>
	<link rel="stylesheet" type="text/css" href="../main/resources/css/user&admin.css">
	<link rel="icon" type="image/x-ico" href="../main/resources/images/stu.ico">
</head>
...
<body>
	...
	<script src="../main/resources/js/jquery-3.1.1.min.js"></script>
	<script src="../main/resources/js/admin.js"></script>
</body>
</html>